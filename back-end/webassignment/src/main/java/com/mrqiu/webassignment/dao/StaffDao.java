...
public interface StaffDao {
     ...
     */
    String checkStaff(@Param("userName") String userName,@Param("password") String password);
     ...
     * @return
     */
    String getStaffGenderById(String staffId);
     ...
     * @return
     */
    String getStaffDepartmentById(String staffId);
     ...
     * @return
     */
    Integer updateStaffHoliday(@Param("staffId") String staffId, @Param("salaryHoliday") int salaryHoliday);
