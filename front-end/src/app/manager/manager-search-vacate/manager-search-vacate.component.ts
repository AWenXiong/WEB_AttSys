...
@Component({
  selector: 'app-manager-search-vacate',
  templateUrl: './manager-search-vacate.component.html',
  styleUrls: ['./manager-search-vacate.component.css']
})
export class ManagerSearchVacateComponent implements OnInit {
  ...
  onEdit(applyId: string): void {
    this.LSData.setObject('updateManagerVacateId', applyId);
    this.router.navigateByUrl('/manager-search-vacate/update');
  }
